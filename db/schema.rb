...
ActiveRecord::Schema.define(version: 20171117220031) do
  ...
  create_table "posts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["keyword_id"], name: "index_posts_on_keyword_id", using: :btree
    t.index ["provider_id"], name: "index_posts_on_provider_id", using: :btree
  end
  ...
  add_foreign_key "posts", "providers"
end
